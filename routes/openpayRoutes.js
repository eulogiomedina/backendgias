...
console.log('Merchant:', process.env.OPENPAY_MERCHANT_ID);
console.log('Private:', process.env.OPENPAY_PRIVATE_KEY ? '[OK]' : '[MISSING]');
console.log('Sandbox:', process.env.OPENPAY_SANDBOX);
